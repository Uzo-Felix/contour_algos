(function (global) {
  ...
  class IsolineBuilder {
    ...
    /**
     * Check if a chain is naturally closed (for LineString analysis)
     */
    isChainClosed(chain) {
    ...
    /**
     * Build LineStrings with enhanced validation and statistics
     */
    ...
    /**
     * Build isolines with enhanced validation and statistics
     */
  ...
  // Export for browser
  global.IsolineBuilder = IsolineBuilder;
